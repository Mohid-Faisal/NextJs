...
const AddRecieverDialog = ({ triggerLabel = "Add Reciever" }: { triggerLabel?: string }) => {
              ...
              field === "ActiveStatus" ? null : (
                <div className="space-y-1" key={field}>
                  ...
                  <Input
                    ...
                    required={field !== "SpecialInstructions" && field !== "ActiveStatus"}
                    placeholder={label}
                    className="text-sm"
                  />
                </div>
...
export default AddRecieverDialog;
