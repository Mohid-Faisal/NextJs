...
export default function IncomeInvoicesPage() {
  ...
  const exportToCSV = () => {
    ...
    link.download = `customer_invoices_${
                  ...
                  <div className="flex flex-col lg:flex-row gap-2 sm:gap-4">
                      ...
                      <div className="grid grid-cols-7 gap-1 text-xs">
                        ...
                        {getDaysInMonth(currentMonth).map((day, index) => (
                          <button
                            ...
                            className={`p-2 text-center text-xs rounded hover:bg-green-50 dark:hover:bg-green-900 ${
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-7 gap-1 text-xs">
                        ...
                        {getDaysInMonth(addMonths(currentMonth, 1)).map(
                          (day, index) => (
                            <button
                              key={index}
                              onClick={() => handleDateClick(day)}
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end" className="w-48">
                            ...
                            <DropdownMenuItem
                              ...
                              className={
                                i.status === "Paid" ? "bg-green-50" : ""
                              }
                            >
                              <span className="mr-2 h-4 w-4 rounded-full bg-green-100 text-green-800 text-xs flex items-center justify-center">
                                ✓
                              </span>
                              Mark as Paid
                            </DropdownMenuItem>
                            <DropdownMenuItem
                              onClick={() =>
                                handleStatusChange(i.id, "Overdue")
                              }
                              className={
                                i.status === "Overdue" ? "bg-red-50" : ""
                              }
                            >
                              <span className="mr-2 h-4 w-4 rounded-full bg-red-100 text-red-800 text-xs flex items-center justify-center">
                                !
                              </span>
                              Mark as Overdue
                            </DropdownMenuItem>
                            <DropdownMenuItem
                              ...
                              className={
                                i.status === "Cancelled" ? "bg-gray-50" : ""
                              }
                            >
                              <span className="mr-2 h-4 w-4 rounded-full bg-gray-100 text-gray-800 text-xs flex items-center justify-center">
                                ✕
                              </span>
                              Mark as Cancelled
                            </DropdownMenuItem>
