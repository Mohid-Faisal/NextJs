          ...
          <style>
            ...
            * {
            ...
            @media print {
              ...
              .terms-body { font-size: 7.2px !important; line-height: 1.25 !important; }
              .terms-title { font-size: 9.5px !important; }
              @page {
                size: A4 portrait;
                margin: 6mm;
              }
      ...
      <div className="waybill-wrapper">
        <div className="waybill-container" style={{ position: 'relative' }}>
          ...
          >
            ...
            <div className="terms-body" style={{ fontSize: '7.2px', lineHeight: '1.25', color: '#000' }}>
              <div className="terms-notice" style={{ marginBottom: '4px', textAlign: 'justify' }}>
              ...
              >
                <div className="terms-section" style={{ marginBottom: '3px' }}>
