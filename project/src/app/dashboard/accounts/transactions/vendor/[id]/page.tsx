...
export default function VendorTransactionsPage() {
  ...
  useEffect(() => {
    fetchVendorData();
  }, [vendorId, page, searchTerm, dateRange, sortField, sortOrder, limit]); // Add limit to dependencies
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/accounts/transactions/vendor/${vendorId}`, {
        method: "POST",
        headers: {
