...
export default function RecipientsPage() {
  ...
  const handleDownloadTemplate = () => {
    ...
    const rows = [
      ["Beta LLC", "Jane Smith", "jane@beta.com", "+198765432", "United Kingdom", "London", "London", "EC1A 1BB", "456 Regent St"]
    ];
    ...
    toast.success("Recipients template downloaded successfully!");
  };
